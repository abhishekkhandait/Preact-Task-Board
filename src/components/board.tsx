            ...
            <div class="board">
                ...
                <div class="mdl-grid">
                    <div class="mdl-cell mdl-cell--3-col category" data-category="New">
                        <Category categorytype="New" tasks={this.filterTaskForCategory(this.state.tasks, "New")} onTaskMove={this.onTaskDrop}  ></Category>
                    </div>
                    <div class="mdl-cell mdl-cell--3-col category" data-category="On-Hold">
                        <Category categorytype="On-Hold" tasks={this.filterTaskForCategory(this.state.tasks, "On-Hold")} onTaskMove={this.onTaskDrop} ></Category>
                    </div>
                    <div class="mdl-cell mdl-cell--3-col category" data-category="In-Progress">
                        <Category categorytype="In-Progress" tasks={this.filterTaskForCategory(this.state.tasks, "In-Progress")} onTaskMove={this.onTaskDrop} ></Category>
                    </div>
                    <div class="mdl-cell mdl-cell--3-col category" data-category="Done">
                        <Category categorytype="Done" tasks={this.filterTaskForCategory(this.state.tasks, "Done")} onTaskMove={this.onTaskDrop} ></Category>
                    </div>
                </div>
            </div>
        )
